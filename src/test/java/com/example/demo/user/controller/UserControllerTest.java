...
public class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_전달_받을_수_있다() throws Exception {
        mockMvc.perform(get("/api/users/1"))
                ...
                .andExpect(jsonPath("$.nickname").value("gihyunglee"))
    ...
    void 사용자는_인증코드로_계정을_활성화_시킬_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/2/verify")
                        .queryParam("certificationCode", "aaaaaa-aaaa-aaaa-aaaa-aaaaaa"))
    ...
    void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갖고_올_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/me")
                        .header("EMAIL", "gihyung.coding@gmail.com"))
                .andExpect(status().isOk())
    ...
    void 사용자는_내_정보를_수정할_수_있다() throws Exception {
        ...
        mockMvc.perform(put("/api/users/me")
                ...
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.email").value("gihyung.coding@gmail.com"))
                .andExpect(jsonPath("$.nickname").value("gihyunglee1_1"))
                .andExpect(jsonPath("$.status").value("ACTIVE"))
